...
- [x] Task 8: lisää `assign_to_system(ifc, products, system)`-helper joka käyttää `ifcopenshell.api.run("group.assign_group", ...)` tai luo IfcRelAssignsToGroup manuaalisesti, ja vastaava testi.
