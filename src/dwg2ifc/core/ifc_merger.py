"""Merge a MagiCAD-exported IFC into the master IFC dwg2ifc just wrote.

Why this module exists
----------------------

dwg2ifc reads only DXF; MagiCAD parts native to a DWG don't reach
the master IFC through any of dwg2ifc's own paths. The recommended
...
the master IFC that dwg2ifc wrote for Lauri's KYL-LISP shelves /
...
def merge_magicad_ifc(
    ...
    *,
    ...
    ``master_path``: IFC dwg2ifc just wrote (Lauri's KYL parts).
