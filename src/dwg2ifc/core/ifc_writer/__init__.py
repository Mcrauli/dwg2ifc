...
symbol stays importable as ``dwg2ifc.core.ifc_writer.X`` so neither
...
from dwg2ifc.core.ifc_writer.mesh import _mesh_to_brep  # noqa: F401 — tests import this
from dwg2ifc.core.ifc_writer.orchestrator import FileEntry, convert, convert_dxf
