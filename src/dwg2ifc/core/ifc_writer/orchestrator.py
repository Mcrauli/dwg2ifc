...
from dwg2ifc.core.ifc_writer.skeleton import (
    IfcSkeleton,
    build_ifc_project_skeleton,
)
from dwg2ifc.core.mapper import apply_profile
...
def _process_one_file(
    ...
    *,
    ...
    if input_path.suffix.lower() == ".dwg":
        from dwg2ifc.core.dwg_preconvert import convert_dwg_to_dxf
        dwg_workdir = Path(tempfile.mkdtemp(prefix="dwg2ifc_dwgin_"))
    ...
    if preprocess_acis:
        from dwg2ifc.core.preprocessing import extract_acis_meshes
    ...
    if profile.positio is not None:
        from dwg2ifc.core.positio import (
...
def convert_dxf(
    *,
    ...
    :func:`dwg2ifc.core.quality.validate_ifc` when ``validate=True`` (or
    ...
    .dxf to ``%TEMP%/dwg2ifc_dwgin_*/``, and the existing pipeline
    ...
    *,
    ...
    def _record(m: object, product: object) -> None:
        ...
        try:
            ...
            pass
        try:
            from dwg2ifc.core.ifc_writer.styling import apply_color_to_product
    ...
    try:
        ...
        if validate:
            from dwg2ifc.core.quality import validate_ifc as _validate_ifc
