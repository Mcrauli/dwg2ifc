...
from dwg2ifc.core.types import BlockInstance, LineGeometry, PolygonGeometry
...
def _customize_file_header(ifc: ifcopenshell.file, *, output_name: str) -> None:
    ...
    fn.setArgumentAsString(4, f"dwg2ifc {__version__}")
    fn.setArgumentAsString(5, "dwg2ifc-kylmalaite")
...
def _customize_application(ifc: ifcopenshell.file) -> None:
    ...
    "dwg2ifc-kylmalaite" instead of an empty slot or a generic
    IfcOpenShell stamp.
    """
    import time
    ...
    if existing_apps:
        for app in existing_apps:
            app.ApplicationIdentifier = "dwg2ifc-kylmalaite"
            app.ApplicationFullName = "dwg2ifc — Kylmäsuunnittelu"
    ...
    application = ifc.create_entity(
        ...
        Version=__version__,
        ApplicationFullName="dwg2ifc — Kylmäsuunnittelu",
        ApplicationIdentifier="dwg2ifc-kylmalaite",
    )
