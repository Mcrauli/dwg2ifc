...
def extract_acis_meshes(
    ...
    *,
    ...
    workdir = Path(tempfile.mkdtemp(prefix="dwg2ifc_acis_"))
    ...
    try:
        ...
        if sys.platform == "win32":
            ...
            # standalone process (no inherited console). When dwg2ifc is
...
def maybe_preprocess(
    ...
    *,
    ...
    invoked from :func:`dwg2ifc.core.ifc_writer.convert_dxf` directly,
    keeping the DXF and the mesh side-channel as separate inputs to
    :func:`dwg2ifc.core.dxf_reader.read_dxf`. This shim exists so older
