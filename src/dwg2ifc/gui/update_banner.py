...
newer dwg2ifc release is available on GitHub.

The banner is wired by :class:`MainWindow` to:
    1. A background ``UpdateChecker`` worker that polls
       :func:`dwg2ifc.core.updater.check_for_update` once on startup.
...
from dwg2ifc.core.updater import (
    DEFAULT_REPO,
    UpdateInfo,
    check_for_update,
    download_asset,
...
class UpdateProgressDialog(QtWidgets.QProgressDialog):
    ...
    def __init__(
        ...
        self.setWindowTitle("dwg2ifc — päivitys")
