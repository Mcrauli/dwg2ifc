...
def _populate_valid_line_rule(dialog) -> None:
    # The dialog defaults to KYL (refrigeration is the app's primary
    # domain); explicitly switch to ARK so the Talo2000 fields apply
...
def test_rule_edit_dialog_domain_combo_toggles_rava_fields(qtbot):
    ...
    # KYL by default: talo2000 hidden, RAVA combos visible.
